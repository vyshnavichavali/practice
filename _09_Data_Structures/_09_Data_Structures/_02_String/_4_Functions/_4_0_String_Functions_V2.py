...
x = 10
y = x ** 2 # I have  to use both x and y
x = x ** 2 # I dont want to use existing x value


# String Functions/Methods : 40 : 10(Frequently used)
#=====================================================
...
print("String after capitalize2  :", str1.capitalize())  # print(10)  Hello
print("String after capitalize3  :", str1)               # hello

str2 = str1.capitalize()                            # x = 10
print("String after capitalize  :", str1, str2)     # print("Value : ", x)
                                                    # hello Hello
...
str1 = 'hello'
print("String     : ", str1)
print("Capitalize : ", str1.capitalize())  # print(10)  # CRATE
print("String     : ", str1)

# REQ 2 : Current string should be used as is, new string used in "multiple places"
print("----Way 2--------")
str1 = 'hello'
print("String1     : ", str1)
str2 = str1.capitalize()   # CREATE        # x = 10
print("String1     : ", str1)
print("String2     : ", str2)     # print(x)

# REQ 3 : Current string should get modified
print("---hello-Way 3--------")
str1 = 'hello'
print("String     : ", str1)
str1 = str1.capitalize()  # UPDATE  x = 10    x = 20
print("String     : ", str1)
...
# 4. decode() : Decodes the string using the code registered for encoding.
str1 = 'hello world'
...
# 36. title() : returns title case (Capitalize each word of the string).
